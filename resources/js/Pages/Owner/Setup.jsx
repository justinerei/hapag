...
// ── Success Modal (shown first for newly registered owners) ──────────────────
...
function RestaurantFormModal({ categories = [] }) {
    ...
    return (
        <Backdrop>
            <div
                className="max-w-3xl mx-auto bg-gray-50 rounded-2xl shadow-2xl overflow-hidden"
            ...
            >
                ...
                <div className="text-center px-8 pb-2">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800 leading-tight">
                        Register your{' '}
                        <span className="text-green-500">restaurant</span>
                    </h2>
                ...
                <div className="p-8 pt-6 max-h-[65vh] overflow-y-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                placeholder={'e.g. "Filipino comfort food made with\ngenerations of love and tradition."'}
                            />
                    ...
                    <div className="mt-8">
                        <button
                            onClick={submit}
                            disabled={processing}
                            className="w-full py-3.5 rounded-xl bg-gray-800 text-white text-sm font-bold hover:bg-gray-900 transition-colors disabled:opacity-50"
                        >
                    ...
                    <p className="text-center text-xs text-gray-400 mt-4">
                        Note: Your restaurant will appear on Hapag once approved by our admin team.
                        You'll be redirected to your dashboard after submission.
                    </p>
                </div>
            </div>
        </Backdrop>
