        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm h-16 flex items-center">
                <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 flex items-center gap-6">
                    ...
                    <Link
                        href={route('home')}
                        className="shrink-0 text-xl font-extrabold tracking-tight text-gray-800 hover:text-green-500 transition-colors"
                    >
                        🍽️ Hapag
                    </Link>
                        ...
                        {navLinks.map(({ label, href }) => (
                            <Link
                                ...
                                className={`px-3 py-1.5 rounded-md text-sm font-semibold transition-colors ${
                                    isActive(new URL(href).pathname)
                    ...
                    <div className="flex items-center gap-1 ml-auto">
                        ...
                        {user ? (
                                ...
                                <div className="relative" ref={profileRef}>
                                    ...
                                    >
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             className={`h-4 w-4 text-gray-500 shrink-0 transition-transform ${profileOpen ? 'rotate-180' : ''}`}
                                    ...
                                    {profileOpen && (
                                        <div className="absolute top-full right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-200 py-2 w-48 z-50">
                                            ...
                                            <Link
                                                ...
                                                className="flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold text-gray-800 hover:bg-gray-100 transition-colors"
                                            ...
                                            <div className="border-t border-gray-200 mt-1 pt-1">
                                                <button
                                                    onClick={logout}
                                                    className="flex items-center gap-2.5 w-full px-4 py-2.5 text-sm font-semibold text-red-500 hover:bg-red-50 transition-colors"
                                                >
                            ...
                            <div className="flex items-center gap-2">
                                <Link
                                    href={route('login')}
                                    className="px-3 py-1.5 rounded-md text-sm font-semibold text-gray-500 hover:text-gray-800 hover:bg-gray-100 transition-colors"
                                >
                                    Sign In
                                </Link>
                                <Link
                                    href={route('register')}
                                    className="px-3 py-1.5 rounded-md text-sm font-semibold bg-green-500 text-white hover:bg-green-600 transition-colors"
                                >
                                    Sign Up
                                </Link>
                            </div>
                        ...
                        <div className="px-4 py-3 space-y-1">
                            ...
                            {!user && (
                                <>
                                    <Link
                                        href={route('login')}
                                        className="block px-3 py-2.5 rounded-md text-sm font-semibold text-gray-800 hover:bg-gray-100 transition-colors"
                                        onClick={() => setMobileOpen(false)}
                                    >
                                        Sign In
                                    </Link>
                                    <Link
                                        href={route('register')}
                                        className="block px-3 py-2.5 rounded-md text-sm font-semibold bg-green-500 text-white hover:bg-green-600 transition-colors"
                                        onClick={() => setMobileOpen(false)}
                                    >
                                        Sign Up
                                    </Link>
